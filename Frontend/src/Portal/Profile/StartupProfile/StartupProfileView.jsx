          ...
          {teamForRender && teamForRender.length ? (() => {
            ...
            return (
              <>
                ...
                {teamForRender.length > 6 + founderOffset && (
                  <div className="team-see-more" onClick={() => setShowAllTeam(s => !s)} style={{ alignSelf: 'center', marginTop: 8 }}>{showAllTeam ? 'Show less' : `+${teamForRender.length - (6 + founderOffset)} more`}</div>
                )}
                {isEditing && (
