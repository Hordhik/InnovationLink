                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="form-section">
                            ...
                            <div className="logo-upload-area">
                                ...
                                <div>
                                    <button type="button" className="btn btn-secondary" onClick={() => fileInputRef.current && fileInputRef.current.click()}>
                                        Upload
                                    </button>
                                    <input ref={fileInputRef} type="file" accept="image/*" className="hidden-input" onChange={handleLogoChange} />
                                </div>
                            </div>
                        ...
                        <div className="form-section">
                            ...
                            {team.map((m, i) => (
                                <div key={i} className="team-input-row">
                                    <input className="form-input flex-grow" value={m.name} onChange={(e) => handleTeamChange(i, e.target.value)} placeholder="Enter team member's name"/>
